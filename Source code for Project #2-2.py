...
X_train_numerical = extract_numerical_cols(X_train)

X_test_numerical = extract_numerical_cols(X_test)

dt_predictions = train_predict_decision_tree(X_train_numerical, Y_train, X_test_numerical)

rf_predictions = train_predict_random_forest(X_train_numerical, Y_train, X_test_numerical)

svm_predictions = train_predict_svm(X_train_numerical, Y_train, X_test_numerical)
